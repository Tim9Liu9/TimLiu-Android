 ...
 * [live-transcribe-speech-engine](https://github.com/google/live-transcribe-speech-engine) - 语音识别转录工具——Live Transcribe的语音引擎，它可以将语音或对话实时转录为文字，还能够为听障人士提供帮助。支持超过70种语言，并能够根据语音自动识别语种，其中也包括中文。 
